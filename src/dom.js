  ...
  document.querySelector(".board button").onclick = function() {
    // getting id property https://stackoverflow.com/questions/4825295/javascript-onclick-to-get-the-id-of-the-clicked-button
    let id = this.id;
    console.log(id);
